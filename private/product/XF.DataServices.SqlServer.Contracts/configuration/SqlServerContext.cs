// <copyright file="SqlServerContext.cs" company="eXtensoft LLC">
            ...
            if (m != null)
            {
                ...
                else
                {
                    ...
                    if (a != null)
                    {
                        ...
                        switch (a.Strategy)
                        {
                            case StrategyOption.ModelDataGateway:
                                implementorType = m.modelDataGatewayType;
                                break;
                    ...
                    else
                    {
                        ...
                        else if (strategy == StrategyOption.ModelDataGateway)
                        {
                            implementorType = m.modelDataGatewayType;
                        }
