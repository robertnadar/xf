// <copyright file="Criterion.cs" company="eXtensoft LLC">
...
namespace XF.Common
{
    ...
    public class Criterion : ICriterion
    {
        ...
        public static ICriterion GenerateStrategy(string switchKey, string strategyCase)
        {
            Criterion criteria = new Criterion();
            if (criteria != null)
            {
                criteria.AddItem(XFConstants.Application.STRATEGYKEY, switchKey);
                criteria.AddItem(switchKey, strategyCase);
            }
